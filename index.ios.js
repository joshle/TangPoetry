...
class TangPoetry extends Component {
  constructor(props) {
    super(props);
    this.state = {
      selectedTab: 'poetry',
  ...
  render() {
    return (
      <TabBarIOS barTintColor="#fff" >
        <TabBarIOS.Item
          title="唐诗"
          selected={this.state.selectedTab === 'poetry'}
          //icon={require('image!poetry')}
